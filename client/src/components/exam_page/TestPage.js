...
export default function TestPage(props){
  ...
  function sendLogsToServer(){
    axios.post(`https://practo-backend-ib8w.onrender.com/api/logs/update`,{
          exam_code: exam_id,
  ...
  function getPreviousLogs(){
      axios.get(`https://practo-backend-ib8w.onrender.com/api/logs/logByEmail?exam_code=`+exam_id+'&student_email='+student_email)
      .then(function (response) {
          console.log(response);
